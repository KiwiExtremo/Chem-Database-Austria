...
--
-- Servidor: localhost
-- Tiempo de generación: 09-07-2023 a las 20:33:17
...
(1401, 'dummy chemical 1', 531, 157),
(1402, 'dummy chemical 2', 532, 158),
(1403, 'dummy chemical 3', 531, 158),
(1406, 'dummy chemical 4', 533, 157);
...
(1401, 'nicht', 'nicht', 'nicht', 'nicht', 'nicht', 'nicht', 'nicht', 'nicht'),
(1402, 'ach', 'ach', 'ach', 'ach', 'ach', 'ach', 'ach', 'ach'),
(1403, 'gef', 'gef', 'gef', 'gef', 'gef', 'gef', 'gef', 'gef'),
(1406, 'enfällt', 'enfällt', 'enfällt', 'enfällt', 'enfällt', 'enfällt', 'enfällt', 'enfällt');
...
(531, 'manufacturer 1', 'manufacturer link 1', ''),
(532, 'manufacturer 2', 'manufacturer link 2', 'extra manufacturer link 2'),
(533, 'manufacturer 3', 'manufacturer link 3', 'additional manufacturer link - 3');
...
('Admin', 1, 'Delete, modify and insert chemicals, manufacturers, storages and all fields related to the database'),
('NormalUser', 2, 'Only access to the database in order to be able to make queries to find chemicals and all their information');
...
(1401, '2023-06-30', 'link 1'),
(1402, '2023-06-29', 'link 2'),
(1403, '2023-06-28', 'link 3'),
(1406, '2000-08-30', '<a href=\'https://en.wikipedia.org/wiki/Safety_data_sheet\' target=\'_blank\'>https://en.wikipedia.org/wiki/Safety_data_sheet</a>');
...
--
ALTER TABLE `chemicals`
  MODIFY `ID_NEW` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1410;

--
-- AUTO_INCREMENT de la tabla `dangers`
--
ALTER TABLE `dangers`
  MODIFY `CHEMICAL_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1407;

--
-- AUTO_INCREMENT de la tabla `manufacturer`
--
ALTER TABLE `manufacturer`
  MODIFY `MANUFACTURER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=534;
...
--
ALTER TABLE `storage`
  MODIFY `STORAGE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
